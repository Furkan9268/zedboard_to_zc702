...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_ENET0_PERIPHERAL_ENABLE {0} CONFIG.PCW_I2C0_I2C0_IO {MIO 10 .. 11} CONFIG.PCW_I2C0_PERIPHERAL_ENABLE {1} CONFIG.PCW_SD0_PERIPHERAL_ENABLE {0} CONFIG.preset {ZedBoard*}  ] $processing_system7_0
